...
public class MarrySocialDBHelper {
    ...
    private static final String DATABASE_CREATE_CONTACTS = "create table contacts ( "
            ...
            + "hobby integer, gender integer, astro integer, introduce text, profession text, directfriendscount integer, is_new integer, "
    ...
    private static final String DATABASE_CREATE_IMAGES = "create table images ( "
            ...
            + "photo_remote_org_path text, photo_remote_small_thumb_path text, photo_remote_big_thumb_path text, current_status integer )";
